...
class mclass:
    def __init__(self,  window,data):
        ...
        self.contract.insert(END,self.data[0].loc["contractSymbol"])
        ...
        self.s0.insert(END,self.data[1])
        ...
        self.deltat.insert(END,self.data[3])
        ...
        self.strike.insert(END,self.data[0].loc["strike"])
        ...
        self.bid.insert(END,self.data[0].loc["bid"])
        ...
        self.ask.insert(END,self.data[0].loc["ask"])
